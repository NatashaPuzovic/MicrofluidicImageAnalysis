%% GlobWatch (blurred image filter)
% this code takes in raw stacks of BF and RFP images, splits them, segments
% RFP images, identifies blurred frames in each stack and outputs sharp
% image stacks, as well as a table with three columns:
% stack name - frame in stack - blurriness (0 not blurred, 1 blurred)
...
clc;
clear;
cd 'D:\Github\Natasha\ImageAnalysis\BlurFilter\';
